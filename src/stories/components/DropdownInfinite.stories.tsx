...
export const Searchable = TemplateMultiple.bind({});
Searchable.args = {
  searchable: true,
};
...
const TemplateOverrideActivator: StoryFn<typeof DropdownInfinite> = (args) => {
  ...
  const renderActivator = useCallback(
    ({ onClick, reference, value }: ActivatorDropdownInfiniteProps) => (
...
export const Custom = TemplateOverrideActivator.bind({});
Custom.parameters = {
  design: {
    type: "figma",
    url: "https://www.figma.com/file/dLpg6DjeBzl6jMtYQYe8uu/0.-Design-System?node-id=6%3A550",
