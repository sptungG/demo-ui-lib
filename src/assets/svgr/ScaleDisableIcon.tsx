...
function SvgScaleDisableIcon(props: ISvgProps) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#scale-disable-icon_svg__a)">
        <path
      ...
      <defs>
        <clipPath id="scale-disable-icon_svg__a">
...
export default SvgScaleDisableIcon;
