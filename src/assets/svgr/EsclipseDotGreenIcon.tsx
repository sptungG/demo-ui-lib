...
function SvgEsclipseDotGreenIcon(props: ISvgProps) {
  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#esclipse-dot-green-icon_svg__a)"
      />
      <path
        ...
        fill="url(#esclipse-dot-green-icon_svg__b)"
      />
      <path
        ...
        fill="url(#esclipse-dot-green-icon_svg__c)"
      />
      <path
        ...
        fill="url(#esclipse-dot-green-icon_svg__d)"
      />
      <defs>
        <linearGradient
          id="esclipse-dot-green-icon_svg__a"
          x1={1.21}
          y1={33.933}
          x2={3.078}
          y2={33.042}
        ...
        >
          <stop stopColor="#0FD186" />
          <stop offset={1} stopColor="#3FDA9E" />
        </linearGradient>
        <linearGradient
          id="esclipse-dot-green-icon_svg__b"
          x1={54.263}
          y1={24.115}
          x2={56.133}
          y2={23.226}
        ...
        <linearGradient
          id="esclipse-dot-green-icon_svg__c"
          x1={8.733}
          y1={25.538}
          x2={32.685}
          y2={14.054}
        ...
        <linearGradient
          id="esclipse-dot-green-icon_svg__d"
          x1={38.747}
          y1={52.771}
          x2={62.729}
          y2={41.273}
...
export default SvgEsclipseDotGreenIcon;
