...
function SvgListFindIcon(props: ISvgProps) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#list-find-icon_svg__a)">
        <path
          d="M17 22H2.848a.85.85 0 0 1-.844-.845V2.848a.85.85 0 0 1 .844-.844h10.169a.901.901 0 0 1 .636.296l4.024 4.746a.892.892 0 0 1 .212.55v1.78a.847.847 0 1 1-1.695 0V7.89l-3.558-4.238h-8.94v16.652h12.498V17.34a.847.847 0 1 1 1.695 0v3.77c-.042.507-.422.89-.89.89Z"
        ...
        <path
          ...
          fill={colorCheck(props.color) || `currentColor`}
        />
        <path d="m18.61 17 2.542 2.542-2.542-2.543Z" fill="#fff" />
        <path
          d="M21.152 20.39a.836.836 0 0 1-.591-.254l-2.543-2.542a.84.84 0 0 1 1.186-1.187l2.543 2.542a.816.816 0 0 1 0 1.187.843.843 0 0 1-.591.253h-.004Z"
          fill={colorCheck(props.color) || `currentColor`}
        />
      </g>
      <defs>
        <clipPath id="list-find-icon_svg__a">
...
export default SvgListFindIcon;
